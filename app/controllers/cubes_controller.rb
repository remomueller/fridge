...
class CubesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @cube.save
        format.html { redirect_to [@cube.tray, @cube], notice: "Cube was successfully created." }
  ...
  def update
    respond_to do |format|
      if @cube.update(cube_params)
        format.html { redirect_to [@cube.tray, @cube], notice: "Cube was successfully updated." }
  ...
  def destroy
    @cube.destroy
    respond_to do |format|
      format.html { redirect_to tray_cubes_url(@tray), notice: "Cube was successfully deleted." }
